...
const Scene = () => {
  ...
  useGSAP(() =>{
    if(!groupRef.current || !can1Ref.current || !can2Ref.current || !can3Ref.current || !can4Ref.current || !can5Ref.current || !can1GroupRef.current || !can2GroupRef.current){
      return
    }
    ...
    .to(can4Ref.current.position, {x: .3 , y: -0.3, z: .25}, 0)
  ...
  return (
    <group ref={groupRef}>
      <group ref={can1GroupRef}>
        <FloatingCan ref={can1Ref} flavor="blackCherry" speed={FLOAT_SPEED}/>
      </group>
