...
/**
 * Item in *AltText → Default → Primary → Text Group*
 */
export interface AltTextSliceDefaultPrimaryTextGroupItem {
  /**
   * Heading field in *AltText → Default → Primary → Text Group*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: alt_text.default.primary.text_group[].heading
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  heading: prismic.TitleField;

  /**
   * Description field in *AltText → Default → Primary → Text Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: alt_text.default.primary.text_group[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
/**
 * Primary content in *AltText → Default → Primary*
 */
export interface AltTextSliceDefaultPrimary {
  /**
   * Text Group field in *AltText → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: alt_text.default.primary.text_group[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  text_group: prismic.GroupField<
    Simplify<AltTextSliceDefaultPrimaryTextGroupItem>
  >;
}

/**
 * Default variation for AltText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type AltTextSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<AltTextSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *AltText*
 */
type AltTextSliceVariation = AltTextSliceDefault;

/**
 * AltText Shared Slice
 *
 * - **API ID**: `alt_text`
 * - **Description**: AltText
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type AltTextSlice = prismic.SharedSlice<
  "alt_text",
  AltTextSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      AltTextSlice,
      AltTextSliceDefaultPrimaryTextGroupItem,
      AltTextSliceDefaultPrimary,
      AltTextSliceVariation,
      AltTextSliceDefault,
      CarouselSlice,
